...
test_lru_zhengyaogu: test_lru_evictor_zhengyaogu.o cs389hw2/lru_evictor.o cs389hw2/cache_lib.o
	$(CXX) $(LDFLAGS) -o $@ $^
...
test_lru_kai_pinckard: test_lru_evictor_kai_pinckard.o hash-it-out/lru_evictor.o hash-it-out/cache_lib.o
	$(CXX) $(LDFLAGS) -o $@ $^
