...
test_fifo_zhengyaogu: test_fifo.o cs389hw2/fifo_evictor.o cs389hw2/cache_lib.o
	$(CXX) $(LDFLAGS) -o $@ $^

test_lru_zhengyaogu: test_lru_evictor.o cs389hw2/lru_evictor.o cs389hw2/cache_lib.o
	$(CXX) $(LDFLAGS) -o $@ $^

test_cache_lib_kai_pinckard: test_cache_lib.o hash-it-out/cache_lib.o
	$(CXX) $(LDFLAGS) -o $@ $^

test_fifo_kai_pinckard: test_fifo.o hash-it-out/fifo_evictor.o hash-it-out/cache_lib.o
	$(CXX) $(LDFLAGS) -o $@ $^

test_lru_kai_pinckard: test_lru_evictor.o hash-it-out/lru_evictor.o hash-it-out/cache_lib.o
	$(CXX) $(LDFLAGS) -o $@ $^
...
clean:
	rm -rf *.o Systems_HW2/*.o test_cache_lib_enderquestral test_fifo_enderquestral test_lru_enderquestral test_cache_lib_zhengyaogu test_lru_zhengyaogu test_fifo_zhengyaogu test_cache_lib_kai_pinckard test_lru_kai_pinckard test_fifo_kai_pinckard
