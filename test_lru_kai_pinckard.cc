...
#include <string.h>
#include <iostream>
#include "hash-it-out/lru_evictor.hh"
#include "catch.hpp"

LRUEvictor* test_evictor = new LRUEvictor();  // A fun exercise for the reader: replace this with a Fifo_evictor and watch it fail.
...
TEST_CASE("test_lru_evictor_basic") {
    ...
    REQUIRE(test_cache.space_used() == 44+297);
